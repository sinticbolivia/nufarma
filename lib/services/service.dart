...
class Service
{
  ...
  static String siteUrl	= 'https://dabox.hexadatos.net'; //'https://prestamos.sinticbolivia.net';
  static String apiUrl	= 'https://dabox.hexadatos.net/api'; //'https://prestamos.sinticbolivia.net/api';
  String	_token	= '';
  ...
  {
    var res 		= await this.get('/prestamos/settings');
