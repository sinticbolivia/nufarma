...
class WidgetHomeProducts extends StatelessWidget {
  ...
  {
    var prov = Provider.of<SessionProvider>(context, listen: false);
    return Container(
        padding: EdgeInsets.all(10),
        height: 300,
        child: FutureBuilder(
          future: ServiceMarket().getBranchProducts(1),
          builder: (ctx, snapshot)
          {
            ...
            if( snapshot.hasData )
            {
              ...
              return ListView(
                  ...
                  children: (items as List).map((e) => this._buildProduct(e, context)).toList()
              );
            }
          },
        )
  ...
  Widget _buildProduct(Product product, context)
  {
    /*
    var product = Product(
                                ...
                                children: [
                                  Row(
                                    children: [
                                      ...
                                      Text('\$' + product.price_sale.toStringAsFixed(2),
                                          style: TextStyle(
                                              fontSize: 15,
